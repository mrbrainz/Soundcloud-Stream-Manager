...
function murkClose() {
	jQuery("ul.lazyLoadingList__list").unbind("DOMNodeInserted",totalMurkHandler);
...
function startmurk() {
	if ((window.location.href === 'https://soundcloud.com/stream') || (window.location.href === 'https://soundcloud.com/stream/')) {
		 jQuery(document).ready(function() { 
			...
			if (!jQuery('#murkconsole').length) {
				...
				jQuery("ul.lazyLoadingList__list").bind("DOMNodeInserted",totalMurkHandler);
			}
