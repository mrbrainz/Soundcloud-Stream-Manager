...
murkconsole = '<div id="murkconsole" style="position:absolute;top:-30px;left:0px; padding: 10px; border: 2px solid orange;z-index:1099;text-align: left;background: #fff;width: 100%;height:0px;overflow-y:auto;box-sizing: border-box;">\
        ...
        <h2 style="margin-bottom: 15px;">Stream Manager \
          ...
          <span class="skipControl sc-ir playControls__control playControls__next skipControl__next" style="float: right; height: 10px; width: 10px; margin-top: 6px; margin-right: 9px; cursor: pointer;" onclick="ssmPlayNext(); return false;">Skip to next</span>\
        </h2>\
